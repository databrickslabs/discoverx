...
def test_scan(spark: SparkSession):
    expected = pd.DataFrame(
        [
            ["None", "default", "tb_1", "ip", "string", "ip_v4", 1.0],
            ["None", "default", "tb_1", "ip", "string", "ip_v6", 0.0],
            ["None", "default", "tb_1", "mac", "string", "ip_v4", 0.0],
            ["None", "default", "tb_1", "mac", "string", "ip_v6", 0.0],
            ["None", "default", "tb_1", "description", "string", "ip_v4", 0.0],
            ["None", "default", "tb_1", "description", "string", "ip_v6", 0.0],
            ["None", "default", "tb_2", "`customer`.`name`", "string", "ip_v4", 0.0],
            ["None", "default", "tb_2", "`customer`.`name`", "string", "ip_v6", 0.0],
            ["None", "default", "tb_2", "`customer`.`contact`.`address`.`street`", "string", "ip_v4", 0.0],
            ["None", "default", "tb_2", "`customer`.`contact`.`address`.`street`", "string", "ip_v6", 0.0],
            ["None", "default", "tb_2", "`customer`.`contact`.`address`.`town`", "string", "ip_v4", 0.0],
            ["None", "default", "tb_2", "`customer`.`contact`.`address`.`town`", "string", "ip_v6", 0.0],
            ["None", "default", "tb_2", "`customer`.`contact`.`address`.`postal_number`", "string", "ip_v4", 0.0],
            ["None", "default", "tb_2", "`customer`.`contact`.`address`.`postal_number`", "string", "ip_v6", 0.0],
            ["None", "default", "tb_2", "`customer`.`contact`.`address`.`country`", "string", "ip_v4", 0.0],
            ["None", "default", "tb_2", "`customer`.`contact`.`address`.`country`", "string", "ip_v6", 0.0],
            ["None", "default", "tb_2", "`customer`.`contact`.`email`", "string", "ip_v4", 0.0],
            ["None", "default", "tb_2", "`customer`.`contact`.`email`", "string", "ip_v6", 0.0],
            ["None", "default", "tb_2", "`customer`.`contact`.`address`.`ips_used`", "array", "ip_v4", 1.0],
            ["None", "default", "tb_2", "`customer`.`contact`.`address`.`ips_used`", "array", "ip_v6", 0.0],
            ["None", "default", "tb_2", "`customer`.`products_owned`", "array", "ip_v4", 0.0],
            ["None", "default", "tb_2", "`customer`.`products_owned`", "array", "ip_v6", 0.0],
        ],
        columns=["catalog", "database", "table", "column", "type", "rule_name", "frequency"],
    )
