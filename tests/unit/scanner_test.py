...
def test_scan(spark: SparkSession):
    expected = pd.DataFrame(
        [
            ...
            ["None", "default", "tb_2", "`customer`.`name`", "ip_v4", 0.0],
            ["None", "default", "tb_2", "`customer`.`name`", "ip_v6", 0.0],
            ["None", "default", "tb_2", "`customer`.`contact`.`address`.`street`", "ip_v4", 0.0],
            ["None", "default", "tb_2", "`customer`.`contact`.`address`.`street`", "ip_v6", 0.0],
            ["None", "default", "tb_2", "`customer`.`contact`.`address`.`town`", "ip_v4", 0.0],
            ["None", "default", "tb_2", "`customer`.`contact`.`address`.`town`", "ip_v6", 0.0],
            ["None", "default", "tb_2", "`customer`.`contact`.`address`.`postal_number`", "ip_v4", 0.0],
            ["None", "default", "tb_2", "`customer`.`contact`.`address`.`postal_number`", "ip_v6", 0.0],
            ["None", "default", "tb_2", "`customer`.`contact`.`address`.`country`", "ip_v4", 0.0],
